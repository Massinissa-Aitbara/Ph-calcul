...
public class Main6Activity extends AppCompatActivity {
    EditText ed1,ed2,ed3,ed8,ed4,ed7,ed5 ,ed6;
    Button btn1,btn2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!ed1.getText().toString().isEmpty() && !ed2.getText().toString().isEmpty() && !ed3.getText().toString().isEmpty() && !ed4.getText().toString().isEmpty() && !ed5.getText().toString().isEmpty() && !ed6.getText().toString().isEmpty() && !ed7.getText().toString().isEmpty() && !ed8.getText().toString().isEmpty()) {
                    if (Double.parseDouble(ed5.getText().toString())<Double.parseDouble(ed6.getText().toString())) {

                        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(Main6Activity.this);
                        ...
                        try {
                            ...
                            Toast.makeText(Main6Activity.this, "Er ", Toast.LENGTH_LONG).show();
                            medicament_model = new medicament_model(-1, "erreur", "erreur", 0, 0, 0, 0, 0, 0);
                        }
                        basededonner basededonner = new basededonner(Main6Activity.this);
                        final boolean success = basededonner.Ajouter3(medicament_model);
                        Toast.makeText(Main6Activity.this, "success =" + success, Toast.LENGTH_LONG).show();
                        ...
                        ed7.setText("");
                        ed8.setText("");
                                Toast.makeText(Main6Activity.this, "Les données ont été bien enregistré", Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(Main6Activity.this, "La concentration minimale est supérieure à la concentration maximale", Toast.LENGTH_LONG).show();

                    }
                }else {
                    Toast.makeText(Main6Activity.this, "Il y a un champ vide  ", Toast.LENGTH_LONG).show();
